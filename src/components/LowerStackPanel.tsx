  ...
  return (
    <div className="mt-10">
      ...
      <div className="relative overflow-visible rounded-[32px] border border-neutral-200/80 bg-white/78 px-6 pb-8 pt-6 shadow-[0_30px_65px_rgba(0,47,167,0.08)] backdrop-blur-sm">
        ...
        <div className="relative min-h-[720px] overflow-visible rounded-[28px] border border-dashed border-neutral-200/90 bg-[linear-gradient(180deg,rgba(245,247,252,0.9),rgba(255,255,255,0.95))] px-4 py-14">
          {pages.length === 0 ? (
            <div
              className="mx-auto flex items-center justify-center rounded-[6px] border border-dashed border-neutral-200 bg-white/55 px-6 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.5)]"
            ...
            <div className="relative min-h-[620px]">
              <div className="pointer-events-none absolute inset-y-4 left-1/2 w-px -translate-x-1/2 bg-[linear-gradient(180deg,transparent,rgba(0,47,167,0.14),transparent)]" />
              {pages.map((page, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      className="absolute inset-0 rounded-[6px] border border-[rgba(0,47,167,0.08)] bg-[linear-gradient(180deg,#f7f8fb,#eceef4)] shadow-[0_26px_44px_rgba(0,47,167,0.08)] [backface-visibility:hidden]"
                      style={{ transform: 'rotateY(180deg)' }}
                    >
                      <div className="absolute inset-y-0 left-[50px] w-px bg-[rgba(0,47,167,0.12)]" />
